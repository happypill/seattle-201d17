# Class 5: More Functions, Understanding Images, plus CSS for Color & Text Styling
...
#### Reminder: Quiz 3 will be published this afternoon and is due at 11:59pm Sunday night.
...
- [Code review, quick look at the readings, and mop-up of weekly topics](#smattering)
...
- [Lab Overview, including more on functions](#lab)
...
- How was pair programming?

- Looking ahead to lab today, we're introducing more new Git flow patterns (branching + collaboration). To set up what we'll be doing in the 2nd half of class today, let' s review the Git patterns we've done so far.

- Code review

- Let's run through the outlines from the readings listed above
...
We'll go over the commands and do some practice with Git branches together in our terminals.

We're also going to need to pimp our prompts!

<a id="lab"></a>
## Code demo for today's lab

Today's work in lab is a 'one-off' lab, in that it is not directly connected to your weekly project.

You'll be working in pairs again today. The GitHub workflow today is different, too, and is designed to give you a lot of practice working with branches, which is the last major piece of Git for us to cover. We need to spend a bit of time with it, and get practice with it, so that you understand what you are doing.
