...
- Announcements
  ...
  - We'll continue 1-on-1 meetings this afternoon during lab time as possible. Managed to do **one** yesterday.
  - There seems to be an increasing amount of people getting sick around campus (such as Aliza, who is out again today):
    - WASH YOUR HANDS!
    - STAY HYDRATED!
    - GET GOOD SLEEP!
    - TAKE ZINC AND VITAMIN C!
    - EAT PHO!
  - We might have a stand-in TA for Aliza today. Sam's waiting to hear back on that.
...
- Discussion on the weekend assignment
