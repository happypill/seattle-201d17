# Assignment Overview: Lab for Weekend Class 10

## Chocolate Pizza: Create a webpage from a provided design comp


For this assignment you will be building a single webpage based off of the provided design comp assets. This assignment is a lot of HTML and CSS, and not as much JS as we've been doing this week. In fact, you may choose to do this project with no JS at all, or just add some as a finishing touch.

**GitHub Repository & Project Setup**

Create a new GitHub repository for this assignment called **chocolate-pizza** and clone it to your laptop. Be sure to do frequent commits, and always do your work on branches! Before starting coding, think about a strategy for approaching this project. What is a practical order in which to do the work:
- Will you wireframe the layout? (Hint: yes, you will)
...
- In what order will you apply CSS to the HTML?
...
OPTIONAL: Add some JavaScript functionality! Get creative, but make sure the style is complete before moving onto any additional features. Wouldn't it be neato if you could actually check those checkboxes by clicking on them?
...
### Remember, this assignment is due at 8:59a Monday morning!!!
